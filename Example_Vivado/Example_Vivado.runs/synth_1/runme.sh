...
HD_PWD='D:/Work/vivadoProject/Example_Vivado/Example_Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_Project_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source design_Project_wrapper.tcl
