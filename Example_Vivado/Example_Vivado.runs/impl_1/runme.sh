...
HD_PWD='D:/Work/vivadoProject/Example_Vivado/Example_Vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_Project_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source design_Project_wrapper.tcl -notrace
