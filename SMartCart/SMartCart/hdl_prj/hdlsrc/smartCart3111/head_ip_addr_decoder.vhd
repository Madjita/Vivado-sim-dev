-- -------------------------------------------------------------
-- 
-- File Name: D:\Matlab_Vhd\hdl_prj\hdlsrc\smartCart3111\head_ip_addr_decoder.vhd
-- Created: 2016-07-17 11:16:23
-- 
...
BEGIN
  ...
  decode_sel_Out1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0041#, 14) ELSE
      '0';
  ...
  decode_sel_Out8 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0049#, 14) ELSE
      '0';

  
  decode_sel_irq <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0048#, 14) ELSE
      '0';

  
  decode_sel_Out7 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0047#, 14) ELSE
      '0';

  
  decode_sel_Out6 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0046#, 14) ELSE
      '0';

  
  decode_sel_Out5 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0045#, 14) ELSE
      '0';

  
  decode_sel_Out4 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0044#, 14) ELSE
      '0';

  
  decode_sel_Out3 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0043#, 14) ELSE
      '0';

  
  decode_sel_Out2 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0042#, 14) ELSE
      '0';
  ...
  decode_rd_irq <= decode_rd_Out7 WHEN decode_sel_irq = '0' ELSE
      data_in_irq;
  ...
  decode_rd_Out8 <= decode_rd_irq WHEN decode_sel_Out8 = '0' ELSE
      data_in_Out8;

  data_read <= std_logic_vector(decode_rd_Out8);
  ...
  decode_sel_data_in_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004A#, 14) ELSE
      '0';
  ...
  decode_sel_data_in_2 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004B#, 14) ELSE
      '0';
  ...
  decode_sel_data_in_3 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004C#, 14) ELSE
      '0';
  ...
  decode_sel_data_in_4 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004D#, 14) ELSE
      '0';
  ...
  decode_sel_data_in_5 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004E#, 14) ELSE
      '0';
  ...
  decode_sel_data_in_6 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#004F#, 14) ELSE
      '0';
  ...
  decode_sel_data_in_7 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0050#, 14) ELSE
      '0';
  ...
  decode_sel_data_in_8 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0051#, 14) ELSE
      '0';
