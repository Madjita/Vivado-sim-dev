-- -------------------------------------------------------------
-- 
-- File Name: D:\Matlab_Vhd\smartCart\OTLADKA\hdlsrc\smartCart4_work\head_ip_src_ColdStart.vhd
...
-- Source Path: smartCart4_work/head/Interface/ColdStart
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  Bit_Concat1_out1 <= unsigned'(Logical_Operator8_out1 & Logical_Operator5_out1 & Logical_Operator4_out1 & Logical_Operator7_out1);
