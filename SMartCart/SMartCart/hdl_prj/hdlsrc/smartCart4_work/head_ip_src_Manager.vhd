-- -------------------------------------------------------------
-- 
-- File Name: D:\Matlab_Vhd\smartCart\OTLADKA\hdlsrc\smartCart4_work\head_ip_src_Manager.vhd
...
-- Source Path: smartCart4_work/head/Manager
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF head_ip_src_Manager IS
  ...
  SIGNAL HDL_Counter11_out1               : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL Logical_Operator25_out1          : std_logic;
  SIGNAL Compare_To_Constant21_out1       : std_logic;
  SIGNAL HDL_Counter11_stepreg            : unsigned(13 DOWNTO 0);  -- ufix14
  ...
  SIGNAL Data_Type_Conversion2_out1       : unsigned(2 DOWNTO 0);  -- ufix3
  ...
  SIGNAL Add6_out1                        : unsigned(32 DOWNTO 0);  -- ufix33
...
BEGIN
  ...
  u_signal_edg5 : head_ip_src_signal_edg
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              In1 => Compare_To_Constant22_out1,
  ...
  --  initial value   = 0
  --  step value      = 1
  --  count to value  = 10416
  HDL_Counter11_step_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      HDL_Counter11_stepreg <= to_unsigned(16#0001#, 14);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Logical_Operator25_out1 = '1' THEN 
          HDL_Counter11_stepreg <= to_unsigned(16#0001#, 14);
        ELSIF Compare_To_Constant21_out1 = '1' THEN 
          IF HDL_Counter11_out1 = to_unsigned(16#28AF#, 14) THEN 
            HDL_Counter11_stepreg <= to_unsigned(16#1750#, 14);
          ELSE 
            HDL_Counter11_stepreg <= to_unsigned(16#0001#, 14);
          END IF;
        END IF;
      END IF;
    END IF;
  END PROCESS HDL_Counter11_step_process;


  Logical_Operator13_out1 <= Logical_Operator3_out1 OR signal_edg5_out1;
  ...
  Compare_To_Constant21_out1 <= '1' WHEN Unit_Delay_Enabled_Resettable2_out1 = to_unsigned(1, 32) ELSE
      '0';

  Logical_Operator25_out1 <=  NOT Compare_To_Constant21_out1;

  HDL_Counter11_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      HDL_Counter11_out1 <= to_unsigned(16#0000#, 14);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Logical_Operator25_out1 = '1' THEN 
          HDL_Counter11_out1 <= to_unsigned(16#0000#, 14);
        ELSIF Compare_To_Constant21_out1 = '1' THEN 
          HDL_Counter11_out1 <= HDL_Counter11_out1 + HDL_Counter11_stepreg;
        END IF;
      END IF;
    END IF;
  ...
  Compare_To_Constant22_out1 <= '1' WHEN HDL_Counter11_out1 = to_unsigned(16#28B0#, 14) ELSE
      '0';
  ...
  Logical_Operator27_out1 <= signal_edg5_out1 AND (Unit_Delay_Enabled_Resettable28_out1_is_not0 AND Logical_Operator29_out1);
  ...
  Data_Type_Conversion2_out1 <= Delay12_out1(2 DOWNTO 0);

  
  Compare_To_Constant20_out1 <= '1' WHEN Logical_Operator3_out1 = '1' ELSE
      '0';
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Compare_To_Constant20_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable18_switch_delay <= to_unsigned(0, 32);
        ELSIF Logical_Operator21_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable18_switch_delay <= data_in_2_unsigned;
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Compare_To_Constant20_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable19_switch_delay <= to_unsigned(0, 32);
        ELSIF Logical_Operator21_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable19_switch_delay <= data_in_3_unsigned;
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Compare_To_Constant20_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable20_switch_delay <= to_unsigned(0, 32);
        ELSIF Logical_Operator21_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable20_switch_delay <= data_in_4_unsigned;
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Compare_To_Constant20_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable21_switch_delay <= to_unsigned(0, 32);
        ELSIF Logical_Operator21_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable21_switch_delay <= data_in_5_unsigned;
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Compare_To_Constant20_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable22_switch_delay <= to_unsigned(0, 32);
        ELSIF Logical_Operator21_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable22_switch_delay <= data_in_6_unsigned;
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Compare_To_Constant20_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable23_switch_delay <= to_unsigned(0, 32);
        ELSIF Logical_Operator21_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable23_switch_delay <= data_in_7_unsigned;
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Compare_To_Constant20_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable24_switch_delay <= to_unsigned(0, 32);
        ELSIF Logical_Operator21_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable24_switch_delay <= data_in_8_unsigned;
        END IF;
      END IF;
    END IF;
  ...
  Index_Vector_out1 <= Unit_Delay_Enabled_Resettable17_out1 WHEN Data_Type_Conversion2_out1 = to_unsigned(16#0#, 3) ELSE
      Unit_Delay_Enabled_Resettable18_out1 WHEN Data_Type_Conversion2_out1 = to_unsigned(16#1#, 3) ELSE
      Unit_Delay_Enabled_Resettable19_out1 WHEN Data_Type_Conversion2_out1 = to_unsigned(16#2#, 3) ELSE
      Unit_Delay_Enabled_Resettable20_out1 WHEN Data_Type_Conversion2_out1 = to_unsigned(16#3#, 3) ELSE
      Unit_Delay_Enabled_Resettable21_out1 WHEN Data_Type_Conversion2_out1 = to_unsigned(16#4#, 3) ELSE
      Unit_Delay_Enabled_Resettable22_out1 WHEN Data_Type_Conversion2_out1 = to_unsigned(16#5#, 3) ELSE
      Unit_Delay_Enabled_Resettable23_out1 WHEN Data_Type_Conversion2_out1 = to_unsigned(16#6#, 3) ELSE
      Unit_Delay_Enabled_Resettable24_out1;
  ...
  Logical_Operator23_out1 <= Delay5_out1 OR Logical_Operator26_out1;
  ...
  Add6_out1 <= resize(Switch11_out1, 33) + resize(Switch15_out1, 33);
