-- -------------------------------------------------------------
-- 
-- File Name: D:\Matlab_Vhd\smartCart\OTLADKA\hdlsrc\smartCart4_work\head_ip_src_MUX2.vhd
...
-- Source Path: smartCart4_work/head/Interface/MUX2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  Data_Type_Conversion_out1 <= signed(Bit_Slice_out1(3 DOWNTO 0));
