-- -------------------------------------------------------------
-- 
-- File Name: D:\Matlab_Vhd\smartCart\OTLADKA\hdlsrc\smartCart5_1work\head_ip_src_Reciver.vhd
...
-- Source Path: smartCart5_1work/head/Reciver
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF head_ip_src_Reciver IS
  ...
  SIGNAL RST_signed                       : signed(2 DOWNTO 0);  -- sfix3
  SIGNAL Bit_Slice1_out1                  : std_logic;  -- ufix1
  SIGNAL Compare_To_Constant33_out1       : std_logic;
  ...
  SIGNAL Unit_Delay_Enabled_Resettable21_switch_delay : std_logic;  -- ufix1
  SIGNAL Unit_Delay_Enabled_Resettable21_out1 : std_logic;
  SIGNAL HDL_Counter6_out1                : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Constant24_out1                  : unsigned(31 DOWNTO 0);  -- uint32
  ...
  SIGNAL Constant23_out1                  : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL time_transmite_unsigned          : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Add2_sub_cast                    : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL Add2_sub_cast_1                  : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL Add2_out1                        : signed(32 DOWNTO 0);  -- sfix33
  SIGNAL Add2_out1_dtc                    : unsigned(31 DOWNTO 0);  -- uint32
  ...
  SIGNAL HDL_Counter8_out1                : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Logical_Operator4_out1           : std_logic;
  SIGNAL Constant29_out1                  : std_logic;
  SIGNAL Constant27_out1                  : std_logic;
  SIGNAL Switch21_out1                    : std_logic;
  SIGNAL Logical_Operator50_out1          : std_logic;
  SIGNAL HDL_Counter9_out1                : unsigned(31 DOWNTO 0);  -- uint32
  ...
  SIGNAL TimOUT_unsigned                  : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Relational_Operator1_relop1      : std_logic;
  SIGNAL Unit_Delay_Enabled_Resettable20_switch_delay : std_logic;  -- ufix1
  SIGNAL Unit_Delay_Enabled_Resettable20_out1 : std_logic;
  SIGNAL HDL_Counter5_out1                : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL signal_edg6_out1                 : std_logic;
  ...
  SIGNAL Constant21_out1                  : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Constant22_out1                  : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Switch16_out1                    : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Add_add_temp                     : unsigned(33 DOWNTO 0);  -- ufix34
  SIGNAL Add_out1                         : unsigned(33 DOWNTO 0);  -- ufix34
...
BEGIN
  ...
  u_signal_edg6 : head_ip_src_signal_edg
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              In1 => Relational_Operator1_relop1,
              Out1 => signal_edg6_out1
              );
  ...
  Bit_Slice1_out1 <= RST_signed(2);

  
  Compare_To_Constant33_out1 <= '1' WHEN IO = '0' ELSE
      '0';
  ...
  Logical_Operator25_out1 <= Logical_Operator47_out1 AND (Bit_Slice1_out1 AND Compare_To_Constant33_out1);

  Logical_Operator2_out1 <=  NOT Logical_Operator25_out1;

  Unit_Delay_Enabled_Resettable21_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Unit_Delay_Enabled_Resettable21_switch_delay <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Logical_Operator2_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable21_switch_delay <= '0';
        ELSIF Logical_Operator25_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable21_switch_delay <= Logical_Operator25_out1;
        END IF;
      END IF;
    END IF;
  ...
  Unit_Delay_Enabled_Resettable21_out1 <= '0' WHEN Logical_Operator2_out1 = '1' ELSE
  ...
  BEGIN
    IF reset = '1' THEN
      HDL_Counter6_out1 <= to_unsigned(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Logical_Operator2_out1 = '1' THEN 
          HDL_Counter6_out1 <= to_unsigned(0, 32);
        ELSIF Unit_Delay_Enabled_Resettable21_out1 = '1' THEN 
          HDL_Counter6_out1 <= HDL_Counter6_out1 + to_unsigned(1, 32);
        END IF;
      END IF;
    END IF;
  ...
  Constant24_out1 <= to_unsigned(1, 32);

  time_transition_unsigned <= unsigned(time_transition);

  
  Switch17_out1 <= Constant24_out1 WHEN ON_RECIVER = '0' ELSE
      time_transition_unsigned;

  
  Relational_Operator3_relop1 <= '1' WHEN HDL_Counter6_out1 = Switch17_out1 ELSE
      '0';

  Constant23_out1 <= to_unsigned(1, 32);

  time_transmite_unsigned <= unsigned(time_transmite);

  Add2_sub_cast <= signed(resize(time_transmite_unsigned, 33));
  Add2_sub_cast_1 <= signed(resize(time_transition_unsigned, 33));
  Add2_out1 <= Add2_sub_cast - Add2_sub_cast_1;

  Add2_out1_dtc <= unsigned(Add2_out1(31 DOWNTO 0));
  ...
  Compare_To_Constant4_out1 <= '1' WHEN Delay3_out1 = to_unsigned(16#0#, 4) ELSE
      '0';

  
  Switch18_out1 <= time_transmite_unsigned WHEN Compare_To_Constant4_out1 = '0' ELSE
      Add2_out1_dtc;

  
  Switch_out1 <= Constant23_out1 WHEN ON_RECIVER = '0' ELSE
      Switch18_out1;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Logical_Operator1_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable_switch_delay <= '0';
        ELSIF Relational_Operator3_relop1 = '1' THEN
          Unit_Delay_Enabled_Resettable_switch_delay <= Relational_Operator3_relop1;
        END IF;
      END IF;
    END IF;
  ...
  Logical_Operator8_out1 <= Logical_Operator48_out1 OR (Relational_Operator2_relop1 OR Logical_Operator7_out1);
  ...
  Relational_Operator2_relop1 <= '1' WHEN HDL_Counter_out1 = Switch_out1 ELSE
      '0';
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Logical_Operator10_out1 = '1' THEN 
          HDL_Counter1_out1 <= '0';
        ELSIF Relational_Operator2_relop1 = '1' THEN 
  ...
  Logical_Operator_out1 <= Compare_To_Constant1_out1 AND Relational_Operator2_relop1;
  ...
  Logical_Operator51_out1 <= Relational_Operator2_relop1 OR (Logical_Operator7_out1 OR Logical_Operator48_out1);
  ...
  Switch20_out1 <= Constant28_out1 WHEN IO = '0' ELSE
      Constant26_out1;

  Logical_Operator49_out1 <= Switch20_out1 AND Unit_Delay_Enabled_Resettable_out1;
  ...
  BEGIN
    IF reset = '1' THEN
      HDL_Counter8_out1 <= to_unsigned(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Logical_Operator51_out1 = '1' THEN 
          HDL_Counter8_out1 <= to_unsigned(0, 32);
        ELSIF Logical_Operator49_out1 = '1' THEN 
          HDL_Counter8_out1 <= HDL_Counter8_out1 + to_unsigned(1, 32);
        END IF;
      END IF;
    END IF;
  ...
  Switch21_out1 <= Constant29_out1 WHEN Logical_Operator4_out1 = '0' ELSE
      Constant27_out1;

  Logical_Operator50_out1 <= Switch21_out1 AND Unit_Delay_Enabled_Resettable_out1;
  ...
  BEGIN
    IF reset = '1' THEN
      HDL_Counter9_out1 <= to_unsigned(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Logical_Operator51_out1 = '1' THEN 
          HDL_Counter9_out1 <= to_unsigned(0, 32);
        ELSIF Logical_Operator50_out1 = '1' THEN 
          HDL_Counter9_out1 <= HDL_Counter9_out1 + to_unsigned(1, 32);
        END IF;
      END IF;
    END IF;
  ...
  Relational_Operator5_relop1 <= '1' WHEN HDL_Counter8_out1 > HDL_Counter9_out1 ELSE
      '0';
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF Logical_Operator12_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable1_switch_delay <= Relational_Operator5_relop1;
        END IF;
      END IF;
    END IF;
  ...
  Compare_To_Constant31_out1 <= '1' WHEN Relational_Operator5_relop1 = '0' ELSE
      '0';
  ...
  TimOUT_unsigned <= unsigned(TimOUT);

  Unit_Delay_Enabled_Resettable20_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Unit_Delay_Enabled_Resettable20_switch_delay <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Relational_Operator1_relop1 = '1' THEN
          Unit_Delay_Enabled_Resettable20_switch_delay <= '0';
        ELSIF Logical_Operator33_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable20_switch_delay <= Logical_Operator33_out1;
        END IF;
      END IF;
    END IF;
  ...
  Unit_Delay_Enabled_Resettable20_out1 <= '0' WHEN Relational_Operator1_relop1 = '1' ELSE
  ...
  BEGIN
    IF reset = '1' THEN
      HDL_Counter5_out1 <= to_unsigned(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF Logical_Operator33_out1 = '1' THEN 
          HDL_Counter5_out1 <= to_unsigned(0, 32);
        ELSIF Unit_Delay_Enabled_Resettable20_out1 = '1' THEN 
  ...
  Relational_Operator1_relop1 <= '1' WHEN HDL_Counter5_out1 = TimOUT_unsigned ELSE
      '0';

  Constant20_out1 <= to_unsigned(16#00#, 8);

  Constant19_out1 <= to_unsigned(16#06#, 8);

  
  Switch15_out1 <= Constant20_out1 WHEN signal_edg6_out1 = '0' ELSE
      Constant19_out1;

  Add1_add_temp <= resize(Switch2_out1, 10) + resize(Switch13_out1, 10);
  Add1_out1 <= Add1_add_temp + resize(Switch15_out1, 10);
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF Logical_Operator13_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable2_switch_delay <= Relational_Operator5_relop1;
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF Logical_Operator14_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable3_switch_delay <= Relational_Operator5_relop1;
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF Logical_Operator15_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable4_switch_delay <= Relational_Operator5_relop1;
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF Logical_Operator16_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable5_switch_delay <= Relational_Operator5_relop1;
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF Logical_Operator17_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable6_switch_delay <= Relational_Operator5_relop1;
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF Logical_Operator18_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable7_switch_delay <= Relational_Operator5_relop1;
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF Logical_Operator19_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable8_switch_delay <= Relational_Operator5_relop1;
        END IF;
      END IF;
    END IF;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF Logical_Operator20_out1 = '1' THEN
          Unit_Delay_Enabled_Resettable9_switch_delay <= Relational_Operator5_relop1;
        END IF;
      END IF;
    END IF;
  ...
  Constant21_out1 <= to_unsigned(0, 32);

  Constant22_out1 <= to_unsigned(1, 32);

  
  Switch16_out1 <= Constant21_out1 WHEN signal_edg6_out1 = '0' ELSE
      Constant22_out1;

  Add_add_temp <= resize(Data_Type_Conversion4_out1, 34) + resize(Switch14_out1, 34);
  Add_out1 <= Add_add_temp + resize(Switch16_out1, 34);
