-- -------------------------------------------------------------
-- 
-- File Name: D:\direct_ip\smart_ip\hdlsrc\smartCart5_1work\head_ip_src_DEMUX.vhd
...
-- Source Path: smartCart5_1work/head/DEMUX
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  Bit_Slice5_out1 <= COMMANDA_unsigned(18 DOWNTO 13);

  Data_Type_Conversion5_out1 <= resize(Bit_Slice5_out1, 8);

  Number_write_byte <= std_logic_vector(Data_Type_Conversion5_out1);

  Bit_Slice6_out1 <= COMMANDA_unsigned(19);

  
  Data_Type_Conversion6_out1 <= '1' WHEN Bit_Slice6_out1 /= '0' ELSE
      '0';

  Bit_Slice7_out1 <= COMMANDA_unsigned(20);

  
  Data_Type_Conversion7_out1 <= '1' WHEN Bit_Slice7_out1 /= '0' ELSE
      '0';

  Bit_Slice8_out1 <= COMMANDA_unsigned(21);

  
  Data_Type_Conversion8_out1 <= '1' WHEN Bit_Slice8_out1 /= '0' ELSE
      '0';
  ...
  ON_RECIVER <= Data_Type_Conversion7_out1;

  select_simk <= Data_Type_Conversion8_out1;
