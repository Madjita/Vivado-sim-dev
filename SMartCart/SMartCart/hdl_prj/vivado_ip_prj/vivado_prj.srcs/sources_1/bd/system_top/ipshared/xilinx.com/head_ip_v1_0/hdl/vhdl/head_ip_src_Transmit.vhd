...
BEGIN
  ...
  Logical_Operator10_out1 <= Delay3_out1 XOR Relational_Operator1_relop1;

  Logical_Operator11_out1 <= Logical_Operator10_out1 AND Relational_Operator1_relop1;

  IO <= Switch1_out1;

  TEST <= Logical_Operator11_out1;
