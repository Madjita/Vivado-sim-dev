...
ARCHITECTURE rtl OF head_ip_src_Reciver IS
  ...
  SIGNAL Fr13_out1_is_not0                : std_logic;
...
BEGIN
  ...
  Fr13_out1_is_not0 <= '1' WHEN Switch1_out1 /= to_unsigned(16#00#, 8) ELSE
      '0';
  ...
  Logical_Operator36_out1 <= Fr13_out1_is_not0 AND Logical_Operator37_out1;
  ...
  Switch6_out1 <= Data_Type_Conversion1_out1 WHEN Switch1_out1 = to_unsigned(16#00#, 8) ELSE
      HDL_Counter3_out1;

  Logical_Operator38_out1 <=  NOT RD;

  Constant6_out1 <= '1';

  
  Switch5_out1 <= Logical_Operator38_out1 WHEN Switch1_out1 = to_unsigned(16#00#, 8) ELSE
      Constant6_out1;

  DataOUT1 <= Single_Port_RAM_out1;

  Strob <= Logical_Operator_out1;
