-- -------------------------------------------------------------
-- 
-- File Name: D:\Matlab_Vhd\smartCart\OTLADKA\hdlsrc\smartCart5_1work\head_ip_addr_decoder.vhd
...
BEGIN
  ...
  decode_sel_Out1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0082#, 14) ELSE
      '0';
  ...
  decode_sel_Out8 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0089#, 14) ELSE
      '0';

  
  decode_sel_Out7 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0088#, 14) ELSE
      '0';

  
  decode_sel_Out6 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0087#, 14) ELSE
      '0';

  
  decode_sel_Out5 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0086#, 14) ELSE
      '0';

  
  decode_sel_Out4 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0085#, 14) ELSE
      '0';

  
  decode_sel_Out3 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0084#, 14) ELSE
      '0';

  
  decode_sel_Out2 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0083#, 14) ELSE
      '0';
  ...
  decode_sel_Time_transition <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0081#, 14) ELSE
      '0';
  ...
  decode_sel_Time_pause <= '1' WHEN addr_sel_unsigned = to_unsigned(16#008A#, 14) ELSE
      '0';
  ...
  decode_sel_Time_reciv <= '1' WHEN addr_sel_unsigned = to_unsigned(16#008B#, 14) ELSE
      '0';
  ...
  decode_sel_Time_transmit <= '1' WHEN addr_sel_unsigned = to_unsigned(16#008C#, 14) ELSE
      '0';
  ...
  decode_sel_Time_interval <= '1' WHEN addr_sel_unsigned = to_unsigned(16#008D#, 14) ELSE
      '0';
