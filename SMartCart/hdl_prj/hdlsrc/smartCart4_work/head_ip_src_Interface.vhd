-- -------------------------------------------------------------
-- 
-- File Name: D:\Matlab_Vhd\smartCart\OTLADKA\hdlsrc\smartCart4_work\head_ip_src_Interface.vhd
...
-- Source Path: smartCart4_work/head/Interface
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF head_ip_src_Interface IS
  ...
  SIGNAL MUX2_out1                        : std_logic_vector(3 DOWNTO 0);  -- ufix4
